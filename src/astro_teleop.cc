  ...
  a_scale_(0.5)
{
  ...
  twist_pub_ = nh_.advertise<geometry_msgs::Twist>("astro_key/cmd_vel", 1);
}
...
{
  ros::init(argc, argv, "teleop_astro");
...
void TeleopTurtle::keyLoop()
{
  ...
  puts("---------------------------");
  puts("Use arrow keys to move astro. 'q' to quit.");
